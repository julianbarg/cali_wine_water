...
biodynamic_full <- read_csv("../data/biodynamic_history.csv", col_types = "ccccDccccccflcl")
glimpse(biodynamic_full)
...
### Save to rds
```{r rds}
saveRDS(biodynamic, "../preprocessed_data/biodynamic.rds")
```